document.addEventListener('DOMContentLoaded', function () {
    ...
    const talks = [
        ...
        { date: "2026-02-25", speaker: "Medina Omarzad", title: "Fitness", description: "I would like to present on fitness from a personal perspective, focusing on how my relationship with movement has evolved over time and how fitness has positively impacted both my physical and mental well-being. The presentation would explore finding balance, building sustainable habits, and choosing forms of movement that are realistic and enjoyable, especially with busy schedules. I’d also touch on lessons learned, common misconceptions about fitness, and how consistency and mindset matter more than perfection." },
        { date: "2026-03-05", speaker: "Ryhana Williams", title: "3D Visual Audio Sequences", description: "TouchDesigner is a real-time, node-based visual programming environment used to create interactive multimedia experiences, from immersive installations to live performances. In my presentation, I’ll explore why TouchDesign creates immense opportunities for the intersection of  technology and design. By blending technical visual programming with artistic intuition, TouchDesigner empowers creators to move beyond static visuals and build dynamic, responsive platforms. My session will highlight how interactive design tools like TouchDesigner are shaping the future of digital creativity and why they’re becoming essential for designers who want to experiment with technology over traditional art." },
        { date: "2026-03-11", speaker: "Maddy Sylvester", title: "Quantum Mechanics", description: "The branch of physics explaining the behaviour of light and matter at different scales and the idea that objects can act as both particles and waves. I will mostly be talking about the uncertainty principle." },
        { date: "2026-03-17", speaker: "James Johnson", title: "The After Effects Trick That Saved Me Days of Work", description: "An after effects preset that allows you to easily sync an animated characters mouth to the voice over in a few simple steps." },
