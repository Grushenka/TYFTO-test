document.addEventListener('DOMContentLoaded', function () {
    ...
    const talks = [
        ...
        { date: "2026-03-", speaker: "James Johnson", title: "The After Effects Trick That Saved Me Days of Work", description: "An after effects preset that allows you to easily sync an animated characters mouth to the voice over in a few simple steps." },
